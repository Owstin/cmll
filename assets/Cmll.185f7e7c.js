import{f as s,s as e,c as a,d as t,F as n,i as g,x as l,y as r}from"./vendor.cc650de8.js";import{_ as i}from"./index.f23e93c5.js";const c=s("<div><span></span></div>"),p=e("div")`
  display: flex;
...
`,x=e("h1")`
  ...
  margin-top: 0;
  margin-bottom: var(--size-4);
`,w=()=>{const s=r();return t(n,{get each(){return Object.entries(s)},children:([s,e])=>t(v,{get children(){return[t(x,{children:s}),t(b,{get children(){return[t(n,{each:e,children:s=>t(h,{get name(){return s.name},get algs(){return s.cases}})}),t(n,{get each(){return new Array(4-e.length%4).fill(0)},children:()=>t(u,{})})]}})]}})})};export{w as default};
