export function __vite_legacy_guard(){import("data:text/javascript,")}import{r as e,a as r,t,c as a,b as R,o as U,d as n,S as o,T as s,e as i,u as c,f as l,p as d,s as h,g as m,i as g,I as u,h as F,j as p,l as f,k as v,m as b,L as k,M as x,n as L,q as y,v as w,R as D,w as $}from"./vendor.cc650de8.js";!function(){const e=document.createElement("link").relList;if(!(e&&e.supports&&e.supports("modulepreload"))){for(const e of document.querySelectorAll('link[rel="modulepreload"]'))r(e);new MutationObserver((e=>{for(const t of e)if("childList"===t.type)for(const e of t.addedNodes)"LINK"===e.tagName&&"modulepreload"===e.rel&&r(e)})).observe(document,{childList:!0,subtree:!0})}function r(e){if(e.ep)return;e.ep=!0;const r=function(e){const r={};return e.integrity&&(r.integrity=e.integrity),e.referrerpolicy&&(r.referrerPolicy=e.referrerpolicy),"use-credentials"===e.crossorigin?r.credentials="include":"anonymous"===e.crossorigin?r.credentials="omit":r.credentials="same-origin",r}(e);fetch(e.href,r)}}();const C={backgroundColor:"var(--color-white)",cardColor:"var(--color-white)",navColor:"var(--color-white)",textColor:"var(--text-color-black)"},z={backgroundColor:"var(--color-grey-800)",cardColor:"var(--color-grey-700)",navColor:"var(--color-green)",textColor:"var(--text-color-white)"},N=i(),M=e=>e?z:C,_=e=>{const[r,t]=a((()=>{const e=window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches;return localStorage.getItem("theme")||(e?"dark":"light")})()),[i,c]=a(M("dark"===r()));return R(U(r,(()=>{localStorage.setItem("theme",r()),c(M("dark"===r()))}),{defer:!0})),n(N.Provider,{value:{switchTheme:()=>{t((e=>"dark"===e?"light":"dark"))},isDarkTheme:()=>"dark"===r()},get children(){return[n(o,{type:"text/css",get children(){return`:root { color-scheme: ${r()} }`}}),n(s,{theme:()=>i(),get children(){return e.children}})]}})},T=l('<input aria-label="Theme toggle" type="checkbox">'),E=l('<div class="track"><div><span></span></div><div><span></span></div></div>'),j=l('<div class="thumb"></div>'),I=h("div")`
  --track-width: 50px;
  --track-height: 24px;
...
`,q=d`
  transform: scale(-1, 1);
`,A=e=>n(I,{get children(){return[(()=>{const r=T.cloneNode(!0);return r.addEventListener("change",(()=>e.toggleTheme())),m((()=>r.checked=e.checked)),r})(),(()=>{const e=E.cloneNode(!0),r=e.firstChild,t=r.firstChild,a=r.nextSibling,R=a.firstChild;return r.className=S,t.className=P,g(t,n(u,{size:18,color:"var(--color-sun)"})),a.className=B,R.className=P,g(R,n(F,{size:18,color:"var(--color-moon)",className:q})),e})(),j.cloneNode(!0)]}}),G=h("header")`
  position: sticky;
  top: 0;
  height: 48px;
  width: 100%;
...
`,Y=()=>{const e=v(J);return n(Q,{get children(){return[n(W,{}),n(X,{get children(){return n(e,{})}})]}})};const Z=()=>[n(b,{children:"BigGreen's cool CMLL page"}),n(k,{rel:"icon",type:"image/x-icon",href:"/cmll/assets/favicon.6c2cd53f.ico"}),n(x,{name:"description",content:"Curated list of BigGreen approved CMLL algoirthms"})];var ee="";const re=L`
  html {
...
`;y(((a,R)=>{let U="";const n=e(a);n&&(U+=`${n}:${R};`);const o=r(a);1&o&&(U+=`-webkit-${a}:${R};`),2&o&&(U+=`-moz-${a}:${R};`),4&o&&(U+=`-ms-${a}:${R};`);const s=t(a,R);return 1&s?U+=`${a}:-webkit-${R};`:2&s?U+=`${a}:-moz-${R};`:4&s&&(U+=`${a}:-ms-${R};`),U+=`${a}:${R};`,U})),w((()=>n(D,{get children(){return n($,{get children(){return n(_,{get children(){return[n(Z,{}),n(re,{}),n(Y,{})]}})}})}})),document.getElementById("root"));export{ee as _};
